...
public class MultiListener extends JFrame
    ...
    public MultiListener() {
        ...
        button1.setActionCommand("ji zhenyan");
        ...
        button2.addActionListener(new Eavesdropper(bottomTextArea));	// Registrear ett annat objekt som lyssnare
    ...
    public static void main(String arg[]){
	  MultiListener mul=new MultiListener();
	  mul.pack();
	  mul.setVisible(true);
   }
}
