...
public class Main {
	...
	private static void testRectangle() {
		//Create two rectangles. Store on as a Rectangle and one as a Shape. Draw them
		...
		//Set new end points to rectangle r1 by calling addPoint with a 
		//new value and then print the new width
		r1.addPoint(5, 5);
		double widthR1 = r1.getWidth();
		System.out.println("\nChanging end point of r1 to (5.0, 5.0)...");
		System.out.println("The width of r1 is now: " + widthR1);
	...
	private static void testCircle() {
		...
		System.out.println("the radius of s1 is now: " + radiusS1);
	}
}
