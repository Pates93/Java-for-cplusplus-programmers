 ...
 * example eliminates flashing by overriding the update
 * method.  For the graphics this example generates, 
 * overriding update isn't quite good enough -- on some
 * systems, you can still see a crawling effect.
 */
